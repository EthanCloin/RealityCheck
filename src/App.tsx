...
import { GuessImage } from "./components/ui/image";
...
function App() {
  ...
  const images = useQuery(api.myFunctions.fetchTwoImages);

  return (
    <>
      <main className="container max-w-2xl flex flex-col gap-8">
        <h1 className="text-3xl font-extrabold mt-8 text-center">
          Can you give a reality check?
        </h1>

        <h2 className="text-center">Which of these is NOT generated by AI?</h2>
        ...
        <div className="flex justify-between items-center">
          {images?.map((image, i) => (
            <ul>
              <GuessImage key={i} url={image.url}></GuessImage>
            </ul>
          ))}
        </div>
